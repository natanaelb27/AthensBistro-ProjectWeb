...
<body>
	<header class="menutiap">
		...
		<div class="buttontiap">
  			...
  			<a href="maincourse.php" class="btn active">Main Course</a>
  			<a href="dessert.php" class="btn">Dessert</a>
	...
	<div class="page-wrapper">
		<div class="container">
			<div class="containercard">
				<?php
				$sql="SELECT * FROM produk JOIN kategori ON produk.id_kategori=kategori.id_kategori WHERE kategori.nama_kategori='Main Course'";
				...
				while($frow=$fquery->fetch_array()){
					...
					?>
					<div class="col-4">
						<div class="cards maincoursecard">
							<div class="imgBx">
