...
<body>
	<header class="menutiap">
		...
		<div class="buttontiap">
  			...
  			<a href="beverages.php" class="btn active">Beverages</a>
  		</div>
	</header>
	<div class="page-wrapper">
		<div class="container">
			<div class="containercard">
				<?php
				$sql="SELECT * FROM produk JOIN kategori ON produk.id_kategori=kategori.id_kategori WHERE kategori.nama_kategori='Beverages'";
