...
<body>
	<header class="menutiap">
		...
		<div class="buttontiap">
  			<a href="appetizer.php" class="btn active">Appetizer</a>
	...
	<div class="page-wrapper">
		<div class="container">
			<div class="containercard">
				<?php
				$sql="SELECT * FROM produk JOIN kategori ON produk.id_kategori=kategori.id_kategori WHERE kategori.nama_kategori='Appetizer'";
